...
import {
  Alert, Card, Spinner, Table, Form, InputGroup,
...
function Recordatorios() {
  ...
  const handleSearchChange = (e) => {
    ...
    if (value) {
      const filtered = recordatorios.filter((recordatorio) => recordatorio.cliente_nombre.toLowerCase().includes(value.toLowerCase())
